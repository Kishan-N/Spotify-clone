  ...
  return (
    ...
    <div className='w-full h-[10%] flex justify-between items-center font-semibold'>
      <div className='flex items-center gap-2'>
        <img onClick={() => navigate(-1)} className='w-8 cursor-pointer rounded-full bg-black p-2' src={assets.arrow_left} />
        <img onClick={() => navigate(+1)} className='w-8 cursor-pointer rounded-full bg-black p-2' src={assets.arrow_right} />
      </div>
